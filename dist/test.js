import { makeDeck, makeGame, dealFromDeck, mergeDecks, makeSequence, makeCard, makeLife, makeTriplet, } from "./cards";
...
assert(remaining.length === nLeft, `Remaining cards ${remaining.length} !== ${nLeft}`);
const game = makeGame(["Murali", "Arun", "Ramu", "Sri"], "Murali");
// debug(
